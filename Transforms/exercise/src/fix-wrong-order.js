...
function fillScene() {
  ...
  // you just have find a way to perform them in the correct order
    ...
    let clockHand = new THREE.Object3D();
    clockHand.add(cube);
	clockHand.rotation.y = -60 * Math.PI/180;
	scene.add( clockHand );
    ...
    let clockHandMin = new THREE.Object3D();
    clockHandMin.add(sphere);
	clockHandMin.rotation.y = 30 * Math.PI/180;

	scene.add( clockHandMin );
}
