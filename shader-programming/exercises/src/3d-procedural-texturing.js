...
import vertexShader from './glsl-shader/3d-procedural-texturing-vertex-shader.glsl'
import fragmentShader from './glsl-shader/3d-procedural-texturing-fragment-shader.glsl'
...
function fillScene() {
	...
	var teapot = new THREE.Mesh(
		new TeapotBufferGeometry(teapotSize, 20, true, true, true, true), phongMaterial);
