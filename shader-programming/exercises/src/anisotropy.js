...
import vertexShader from './glsl-shader/anisotropy-vertex-shader.glsl';
import fragmentShader from './glsl-shader/anisotropy-fragment-shader.glsl';
...
function fillScene() {
	...
	teapot = new THREE.Mesh(
		new TeapotBufferGeometry(teapotSize, tessLevel[tess], false, true, false), phongBalancedMaterial);
