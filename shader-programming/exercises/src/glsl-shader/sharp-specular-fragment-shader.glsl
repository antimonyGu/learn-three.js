...
void main() {
	...
	specular = ( specular < uDropoff ) ? 0.0 : 1.0; // change specular like this way also cause new problem. It is quite aliased at the edge, beacuse the contrast between light and dark is so great. There are ways of modifying the funtion so that it is smoother at a transition point. 
	// Or use some function such as FXAA
