...
void main() {
	...
	/* wrap lighting
		maximum of (vec(N)·vec(L) + WRAP)/(WRAP + 1) and 0
	*/
	// TODO: read navida's guide know the whole technique of ways of Real-Time Approximations to Subsurface Scattering
