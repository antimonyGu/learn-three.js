...
import vertexShader from './glsl-shader/wrap-lighting-vertex-shader.glsl';
import fragmentShader from './glsl-shader/wrap-lighting-fragment-shader.glsl';
...
function createShaderMaterial(id, light, ambientLight) {
	...
	var material = new THREE.ShaderMaterial({ uniforms: u, vertexShader, fragmentShader });
