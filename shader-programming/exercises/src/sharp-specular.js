...
import vertexShader from './glsl-shader/sharp-specular-vertex-shader.glsl';
import fragmentShader from './glsl-shader/sharp-specular-fragment-shader.glsl';
...
function createShaderMaterial(id, light, ambientLight) {
	// One drawback of Blinn-Phong specular highlighting is that the drop off is always gradual around the fringe. So I will change the Blinn-Phong specular term.
	var shaderTypes = {
...
function fillScene() {
	...
	teapot = new THREE.Mesh(
		new TeapotBufferGeometry(teapotSize, tess, true, true, true, true), phongBalancedMaterial);
