...
function init() {
	...
	// TEXTURES
	crateTexture = THREE.ImageUtils.loadTexture( path + './cs291/textures/crate.gif' );
	crateTexture.wrapS = THREE.RepeatWrapping; crateTexture.wrapT = THREE.RepeatWrapping;
	gridTexture = THREE.ImageUtils.loadTexture( path + './cs291/textures/ash_uvgrid01.jpg');
	gridTexture.wrapS = THREE.RepeatWrapping; gridTexture.wrapT = THREE.RepeatWrapping;
	mapleTexture = THREE.ImageUtils.loadTexture( path + './cs291/textures/maple.png' );
	mapleTexture.wrapS = THREE.RepeatWrapping; mapleTexture.wrapT = THREE.RepeatWrapping;
	featherTexture = THREE.ImageUtils.loadTexture( path + './cs291/textures/feather.png' );
