...
function SquareGeometry() {
    ...
    uvs.push( new THREE.Vector2( .75, .25 ) );
	uvs.push( new THREE.Vector2( 1.0, .25 ) );
	uvs.push( new THREE.Vector2( 1.0, .5 ) );
	uvs.push( new THREE.Vector2( .75, .5 ) );
...
function fillScene() {
	...
	var myTexture = THREE.ImageUtils.loadTexture('./cs291/textures/lettergrid.png' );
