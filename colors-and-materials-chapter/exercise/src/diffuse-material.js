...
function createBall() {
	...
	var material = new THREE.MeshLambertMaterial( { color: 0x80FC66 } ); // turn off flat shading than smooth shading is used by default
    // material.ambient.setRGB and material.diffuse are all been deprecated, so I have to find another way to set ambient for the material.
    // So I tried to use ambientLight to instead of it.
    // var ka = 0.4; 
