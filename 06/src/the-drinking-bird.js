...
function createBody() {
    ...
    scene.add( sphere );
    // cylinder
    let cylinder = new THREE.Mesh(new THREE.CylinderGeometry( 24/2, 24/2, 390, 32 ), cylinderMaterial);
...
function createHead() {
	...
	sphere.position.z = 0;
    scene.add( sphere );
    // use two cylinders to make hat
    let brim = new THREE.Mesh(new THREE.CylinderGeometry( 142/2, 142/2, 10, 32 ), cylinderMaterial);
    brim.position.x = 0;
	brim.position.y = 160 + 390 + 40 + 15;;
	brim.position.z = 0;
    scene.add( brim )

    let hatBody = new THREE.Mesh(new THREE.CylinderGeometry( 80/2, 80/2, 70, 32 ), cylinderMaterial);
    hatBody.position.x = 0;
	hatBody.position.y = 160 + 390 + 40 + 15 + 70/2;
