...
function init() {
	...
	// TEXTURES
	texture.crate = THREE.ImageUtils.loadTexture( './img/cs291/textures/crate.gif' );
	texture.grid = THREE.ImageUtils.loadTexture( './img/cs291/textures/ash_uvgrid01.jpg');
	//texture['maple'] = THREE.ImageUtils.loadTexture( './img/cs291/textures/maple.png' );
	//texture['feather'] = THREE.ImageUtils.loadTexture( './img/cs291/textures/feather.png' );
	texture.water = THREE.ImageUtils.loadTexture( './img/cs291/textures/water.jpg' );
	texture.concrete = THREE.ImageUtils.loadTexture( './img/cs291/textures/concrete.jpg' );
	texture.letterR = THREE.ImageUtils.loadTexture( './img/cs291/textures/r_border.png' );
